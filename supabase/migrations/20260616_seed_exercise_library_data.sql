-- Generated from supabase/seed/exercises_seed.sql and supabase/seed/workout_templates_seed.sql
-- This migration bootstraps the public exercise library and workout template catalog.
...
values
  (
    ...
    array['Barbell Side Split Squat', 'Barbell Squat', 'Bodyweight Squat']::text[],
    array[]::text[],
  ...
  (
    ...
    array['Decline Dumbbell Bench Press', 'Dumbbell Bench Press with Neutral Grip', 'Hammer Grip Incline DB Bench Press']::text[],
    array['Decline Dumbbell Bench Press', 'Dumbbell Bench Press with Neutral Grip', 'Hammer Grip Incline DB Bench Press']::text[],
  ...
  (
    ...
    array['Bent Over Two-Arm Long Bar Row', 'Upright Cable Row', 'Bent Over Barbell Row']::text[],
    array['Bent Over Two-Arm Long Bar Row', 'Upright Cable Row', 'Bent Over Barbell Row']::text[],
  ...
  (
    ...
    array['Arnold Dumbbell Press', 'Dumbbell One-Arm Shoulder Press', 'Barbell Shoulder Press']::text[],
    array['Arnold Dumbbell Press', 'Dumbbell One-Arm Shoulder Press']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Skipping the setup and losing tension before the first rep starts.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the legs region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Stiff-Legged Barbell Deadlift', 'Good Morning', 'Good Morning off Pins']::text[],
    array['Good Morning', 'Good Morning off Pins', 'Hanging Bar Good Morning']::text[],
  ...
  (
    ...
    array['Cable Crunch', 'Seated Barbell Twist', '3/4 Sit-Up']::text[],
    array[]::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Skipping the setup and losing tension before the first rep starts.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the legs region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Barbell Side Split Squat', 'Barbell Squat', 'Chair Squat']::text[],
    array[]::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the chest region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Barbell Bench Press - Medium Grip', 'Barbell Incline Bench Press - Medium Grip', 'Cable Chest Press']::text[],
    array[]::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Letting momentum do the work instead of controlling the full rep.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the back region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Bent Over Two-Dumbbell Row With Palms In', 'Dumbbell Incline Row', 'One-Arm Dumbbell Row']::text[],
    array['Bent Over Two-Dumbbell Row With Palms In', 'Dumbbell Incline Row', 'One-Arm Dumbbell Row']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the legs region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Dumbbell Rear Lunge', 'Barbell Walking Lunge', 'Bodyweight Walking Lunge']::text[],
    array['Dumbbell Rear Lunge']::text[],
  ...
  (
    ...
    array['Cable Russian Twists', 'Plank', 'Cable Crunch']::text[],
    array[]::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Skipping the setup and losing tension before the first rep starts.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the legs region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Plie Dumbbell Squat', 'Split Squat with Dumbbells', 'Dumbbell Squat To A Bench']::text[],
    array['Plie Dumbbell Squat', 'Split Squat with Dumbbells', 'Dumbbell Squat To A Bench']::text[],
  ...
  (
    ...
    array['Alternate Hammer Curl', 'Concentration Curls', 'Barbell Curl']::text[],
    array['Alternate Hammer Curl', 'Concentration Curls', 'Barbell Curl']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the arms region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Reverse Grip Triceps Pushdown', 'Cable Rope Overhead Triceps Extension', 'Decline Dumbbell Triceps Extension']::text[],
    array['Reverse Grip Triceps Pushdown', 'Cable Rope Overhead Triceps Extension', 'Decline Dumbbell Triceps Extension']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Letting momentum do the work instead of controlling the full rep.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the legs region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Calf Press On The Leg Press Machine']::text[],
    array[]::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the chest region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Incline Cable Chest Press', 'Standing Cable Chest Press', 'Barbell Bench Press - Medium Grip']::text[],
    array['Incline Cable Chest Press', 'Standing Cable Chest Press']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Letting momentum do the work instead of controlling the full rep.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the back region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Close-Grip Front Lat Pulldown', 'One Arm Lat Pulldown', 'Full Range-Of-Motion Lat Pulldown']::text[],
    array['Close-Grip Front Lat Pulldown', 'One Arm Lat Pulldown', 'Full Range-Of-Motion Lat Pulldown']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the shoulders region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Alternating Cable Shoulder Press', 'Cable Shoulder Press', 'Arnold Dumbbell Press']::text[],
    array['Alternating Cable Shoulder Press', 'Cable Shoulder Press']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Letting momentum do the work instead of controlling the full rep.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the back region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Close-Grip Front Lat Pulldown', 'Kneeling High Pulley Row', 'Kneeling Single-Arm High Pulley Row']::text[],
    array['Close-Grip Front Lat Pulldown', 'Kneeling High Pulley Row', 'Kneeling Single-Arm High Pulley Row']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the core region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Cable Crunch', 'Plank', 'Seated Barbell Twist']::text[],
    array[]::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the legs region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Barbell Walking Lunge', 'Dumbbell Lunges', 'Barbell Lunge']::text[],
    array[]::text[],
  ...
  (
    ...
    array['Dips - Triceps Version', 'Close-Grip Barbell Bench Press', 'JM Press']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the chest region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Barbell Incline Bench Press - Medium Grip', 'Decline Barbell Bench Press', 'Bench Press - Powerlifting']::text[],
    array['Barbell Incline Bench Press - Medium Grip', 'Decline Barbell Bench Press', 'Bench Press - Powerlifting']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the chest region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Dumbbell Bench Press', 'Cable Chest Press', 'Pushups']::text[],
    array['Barbell Bench Press - Medium Grip', 'Decline Barbell Bench Press', 'Hammer Grip Incline DB Bench Press']::text[],
  ...
  (
    ...
    array['Alternating Deltoid Raise', 'Bent Over Dumbbell Rear Delt Raise With Head On Bench', 'Dumbbell Incline Shoulder Raise']::text[],
    array['Alternating Deltoid Raise', 'Bent Over Dumbbell Rear Delt Raise With Head On Bench', 'Dumbbell Incline Shoulder Raise']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the arms region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Bench Dips', 'Dips - Triceps Version', 'JM Press']::text[],
    array['Bench Dips', 'Dips - Triceps Version', 'JM Press']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the arms region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Cable Rope Overhead Triceps Extension', 'Decline Dumbbell Triceps Extension', 'Decline EZ Bar Triceps Extension']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Letting momentum do the work instead of controlling the full rep.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the back region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Bent Over One-Arm Long Bar Row', 'One-Arm Long Bar Row', 'T-Bar Row with Handle']::text[],
    array['Bent Over One-Arm Long Bar Row', 'One-Arm Long Bar Row', 'T-Bar Row with Handle']::text[],
  ...
  (
    ...
    array['Close-Grip Front Lat Pulldown', 'One Arm Lat Pulldown', 'Wide-Grip Lat Pulldown']::text[],
    array['Close-Grip Front Lat Pulldown', 'One Arm Lat Pulldown', 'Wide-Grip Lat Pulldown']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the arms region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Barbell Curls Lying Against An Incline', 'Close-Grip EZ Bar Curl', 'Close-Grip Standing Barbell Curl']::text[],
    array['Barbell Curls Lying Against An Incline', 'Close-Grip EZ Bar Curl', 'Close-Grip Standing Barbell Curl']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the arms region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Alternate Incline Dumbbell Curl', 'Concentration Curls', 'Dumbbell Alternate Bicep Curl']::text[],
    array['Alternate Incline Dumbbell Curl', 'Concentration Curls', 'Dumbbell Alternate Bicep Curl']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Skipping the setup and losing tension before the first rep starts.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the legs region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Barbell Side Split Squat', 'Barbell Full Squat', 'Barbell Hack Squat']::text[],
    array['Barbell Side Split Squat', 'Barbell Full Squat', 'Barbell Hack Squat']::text[],
  ...
  (
    ...
    array['Lying Leg Curls', 'Cable Hip Adduction', 'Barbell Step Ups']::text[],
    array['Lying Leg Curls']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the legs region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Leg Extensions', 'Cable Hip Adduction', 'Barbell Step Ups']::text[],
    array['Leg Extensions']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the arms region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Finger Curls', 'Flexor Incline Dumbbell Curls', 'Seated Dumbbell Inner Biceps Curl']::text[],
    array['Finger Curls', 'Flexor Incline Dumbbell Curls', 'Seated Dumbbell Inner Biceps Curl']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Skipping the setup and losing tension before the first rep starts.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the legs region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Barbell Squat To A Bench', 'Front Barbell Squat To A Bench', 'One Leg Barbell Squat']::text[],
    array['Barbell Squat To A Bench', 'Front Barbell Squat To A Bench', 'One Leg Barbell Squat']::text[],
  ...
  (
    ...
    array['Dumbbell Flyes', 'Incline Dumbbell Flyes', 'Decline Dumbbell Flyes']::text[],
    array['Incline Cable Chest Press', 'Standing Cable Chest Press', 'Cable Chest Press']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the shoulders region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Arnold Dumbbell Press', 'Dumbbell One-Arm Shoulder Press', 'Dumbbell Shoulder Press']::text[],
    array[]::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the arms region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Decline Dumbbell Triceps Extension', 'Decline EZ Bar Triceps Extension', 'One Arm Pronated Dumbbell Triceps Extension']::text[],
    array['Decline Dumbbell Triceps Extension', 'Decline EZ Bar Triceps Extension', 'One Arm Pronated Dumbbell Triceps Extension']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the shoulders region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Dumbbell One-Arm Shoulder Press', 'Dumbbell Shoulder Press', 'Barbell Shoulder Press']::text[],
    array['Dumbbell One-Arm Shoulder Press', 'Dumbbell Shoulder Press']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the shoulders region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Alternating Deltoid Raise', 'Dumbbell Incline Shoulder Raise', 'Front Dumbbell Raise']::text[],
    array['Alternating Deltoid Raise', 'Dumbbell Incline Shoulder Raise', 'Front Dumbbell Raise']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the back region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Barbell Shrug Behind The Back', 'Incline Bench Pull', 'Dumbbell Shrug']::text[],
    array['Barbell Shrug Behind The Back', 'Incline Bench Pull']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the arms region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Barbell Curl', 'Barbell Curls Lying Against An Incline', 'Close-Grip Standing Barbell Curl']::text[],
    array['Barbell Curl', 'Barbell Curls Lying Against An Incline', 'Close-Grip Standing Barbell Curl']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the arms region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Alternate Hammer Curl', 'Alternate Incline Dumbbell Curl', 'Dumbbell Alternate Bicep Curl']::text[],
    array['Alternate Hammer Curl', 'Alternate Incline Dumbbell Curl', 'Dumbbell Alternate Bicep Curl']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the arms region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Bench Dips', 'Close-Grip Barbell Bench Press', 'JM Press']::text[],
  ...
  (
    ...
    array['Barbell Glute Bridge', 'Pull Through']::text[],
    array['Barbell Glute Bridge']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the legs region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Barbell Lunge', 'Elevated Back Lunge', 'Bodyweight Walking Lunge']::text[],
    array['Barbell Lunge', 'Elevated Back Lunge']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the glutes region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Barbell Glute Bridge', 'Barbell Hip Thrust']::text[],
    array[]::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the core region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Barbell Ab Rollout', 'Barbell Rollout from Bench', 'Barbell Ab Rollout - On Knees']::text[],
    array[]::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the core region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Plank', 'Seated Barbell Twist', 'Ab Crunch Machine']::text[],
    array[]::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the legs region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Barbell Step Ups', 'Clean', 'Clean from Blocks']::text[],
    array[]::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the legs region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Dumbbell Clean', 'Barbell Step Ups', 'Power Clean']::text[],
    array['Dumbbell Clean']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Skipping the setup and losing tension before the first rep starts.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the back region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Deficit Deadlift', 'Seated Good Mornings', 'Stiff Leg Barbell Good Morning']::text[],
    array['Deficit Deadlift', 'Seated Good Mornings', 'Stiff Leg Barbell Good Morning']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the chest region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Barbell Bench Press - Medium Grip', 'Dumbbell Bench Press', 'Cable Chest Press']::text[],
    array['Barbell Bench Press - Medium Grip', 'Barbell Incline Bench Press - Medium Grip', 'Dumbbell Bench Press']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the back region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Barbell Shrug', 'Barbell Shrug Behind The Back', 'Dumbbell Shrug']::text[],
    array[]::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Skipping the setup and losing tension before the first rep starts.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the legs region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Barbell Hack Squat', 'Front Squat (Clean Grip)', 'Jefferson Squats']::text[],
    array['Barbell Hack Squat', 'Box Squat', 'Frankenstein Squat']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Skipping the setup and losing tension before the first rep starts.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the legs region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Front Barbell Squat', 'Front Barbell Squat To A Bench', 'One Leg Barbell Squat']::text[],
    array['Front Barbell Squat', 'Front Barbell Squat To A Bench', 'One Leg Barbell Squat']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Letting momentum do the work instead of controlling the full rep.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the back region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Bent Over Barbell Row', 'One-Arm Long Bar Row', 'T-Bar Row with Handle']::text[],
    array['Bent Over Barbell Row', 'One-Arm Long Bar Row', 'T-Bar Row with Handle']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Letting momentum do the work instead of controlling the full rep.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the back region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Bent Over Barbell Row', 'Bent Over One-Arm Long Bar Row', 'One-Arm Long Bar Row']::text[],
    array['Bent Over Barbell Row', 'Bent Over One-Arm Long Bar Row', 'One-Arm Long Bar Row']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the chest region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Barbell Bench Press - Medium Grip', 'Barbell Incline Bench Press - Medium Grip', 'Bench Press - Powerlifting']::text[],
    array['Barbell Bench Press - Medium Grip', 'Barbell Incline Bench Press - Medium Grip', 'Bench Press - Powerlifting']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Skipping the setup and losing tension before the first rep starts.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the legs region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Barbell Squat To A Bench', 'Front Barbell Squat', 'One Leg Barbell Squat']::text[],
    array['Barbell Squat To A Bench', 'Front Barbell Squat', 'One Leg Barbell Squat']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Skipping the setup and losing tension before the first rep starts.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the legs region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Barbell Full Squat', 'Barbell Hack Squat', 'Front Squat (Clean Grip)']::text[],
    array['Barbell Full Squat', 'Barbell Hack Squat', 'Box Squat']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the chest region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Bench Press - Powerlifting', 'Board Press', 'Floor Press']::text[],
    array['Bench Press - Powerlifting', 'Board Press', 'Floor Press']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Skipping the setup and losing tension before the first rep starts.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the legs region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Barbell Squat To A Bench', 'Front Barbell Squat', 'Front Barbell Squat To A Bench']::text[],
    array['Barbell Squat To A Bench', 'Front Barbell Squat', 'Front Barbell Squat To A Bench']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Skipping the setup and losing tension before the first rep starts.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the legs region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Romanian Deadlift', 'Stiff-Legged Barbell Deadlift', 'Clean Deadlift']::text[],
    array['Clean Deadlift', 'Good Morning', 'Good Morning off Pins']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the legs region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Barbell Step Ups', 'Snatch Pull', 'Clean']::text[],
    array['Barbell Step Ups', 'Clean', 'Clean from Blocks']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Skipping the setup and losing tension before the first rep starts.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the back region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Barbell Deadlift', 'Deficit Deadlift', 'Seated Good Mornings']::text[],
    array['Barbell Deadlift', 'Deficit Deadlift', 'Seated Good Mornings']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the chest region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Around The Worlds', 'Bent-Arm Dumbbell Pullover', 'Straight-Arm Dumbbell Pullover']::text[],
    array[]::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the chest region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Bench Press - Powerlifting', 'Wide-Grip Barbell Bench Press', 'Wide-Grip Decline Barbell Bench Press']::text[],
    array['Bench Press - Powerlifting', 'Wide-Grip Barbell Bench Press', 'Wide-Grip Decline Barbell Bench Press']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the legs region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Elevated Back Lunge', 'Barbell Walking Lunge', 'Dumbbell Rear Lunge']::text[],
    array['Elevated Back Lunge', 'Barbell Walking Lunge']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the back region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Rack Pulls', 'Snatch Shrug', 'Clean Shrug']::text[],
    array['Rack Pulls', 'Snatch Shrug', 'Clean Shrug']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Letting momentum do the work instead of controlling the full rep.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the chest region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Incline Dumbbell Press']::text[],
    array[]::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Letting momentum do the work instead of controlling the full rep.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the back region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Bent Over Barbell Row', 'Bent Over One-Arm Long Bar Row', 'T-Bar Row with Handle']::text[],
    array['Bent Over Barbell Row', 'Bent Over One-Arm Long Bar Row', 'T-Bar Row with Handle']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Letting momentum do the work instead of controlling the full rep.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the back region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Bent Over Two-Arm Long Bar Row', 'Bent Over Barbell Row', 'Bent Over One-Arm Long Bar Row']::text[],
    array['Bent Over Two-Arm Long Bar Row', 'Bent Over Barbell Row', 'Bent Over One-Arm Long Bar Row']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Skipping the setup and losing tension before the first rep starts.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the legs region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Romanian Deadlift', 'Good Morning', 'Good Morning off Pins']::text[],
    array['Good Morning', 'Good Morning off Pins', 'Hanging Bar Good Morning']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Skipping the setup and losing tension before the first rep starts.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the legs region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Barbell Full Squat', 'Front Squat (Clean Grip)', 'Jefferson Squats']::text[],
    array['Barbell Full Squat', 'Box Squat', 'Frankenstein Squat']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Skipping the setup and losing tension before the first rep starts.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the legs region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Barbell Squat', 'Barbell Full Squat', 'Barbell Hack Squat']::text[],
    array['Barbell Squat', 'Barbell Full Squat', 'Barbell Hack Squat']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the legs region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Power Clean', 'Snatch Pull', 'Clean']::text[],
    array['Clean', 'Clean from Blocks', 'Clean Pull']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the chest region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Bench Press - Powerlifting', 'Floor Press', 'One Arm Floor Press']::text[],
    array['Bench Press - Powerlifting', 'Floor Press', 'One Arm Floor Press']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Letting momentum do the work instead of controlling the full rep.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the shoulders region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Anti-Gravity Press', 'Standing Bradford Press', 'Standing Military Press']::text[],
    array['Anti-Gravity Press', 'Standing Bradford Press', 'Standing Military Press']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Letting momentum do the work instead of controlling the full rep.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the shoulders region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Seated Barbell Military Press', 'Standing Barbell Press Behind Neck', 'Anti-Gravity Press']::text[],
    array['Seated Barbell Military Press', 'Standing Barbell Press Behind Neck', 'Anti-Gravity Press']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the legs region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Barbell Lunge', 'Barbell Walking Lunge', 'Dumbbell Rear Lunge']::text[],
    array['Barbell Lunge', 'Barbell Walking Lunge']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Skipping the setup and losing tension before the first rep starts.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the legs region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Barbell Full Squat', 'Barbell Hack Squat', 'Jefferson Squats']::text[],
    array['Barbell Full Squat', 'Barbell Hack Squat', 'Box Squat']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the legs region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Barbell Step Ups', 'Power Clean', 'Clean']::text[],
    array['Barbell Step Ups', 'Clean', 'Clean from Blocks']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Letting momentum do the work instead of controlling the full rep.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the shoulders region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Clean and Press', 'Seated Barbell Military Press', 'Anti-Gravity Press']::text[],
    array['Clean and Press', 'Seated Barbell Military Press', 'Anti-Gravity Press']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Letting momentum do the work instead of controlling the full rep.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the shoulders region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Anti-Gravity Press', 'Bradford/Rocky Presses', 'Standing Military Press']::text[],
    array['Anti-Gravity Press', 'Bradford/Rocky Presses', 'Standing Military Press']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Letting momentum do the work instead of controlling the full rep.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the shoulders region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Anti-Gravity Press', 'Bradford/Rocky Presses', 'Standing Bradford Press']::text[],
    array['Anti-Gravity Press', 'Bradford/Rocky Presses', 'Standing Bradford Press']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the chest region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Bench Press - Powerlifting', 'Wide-Grip Decline Barbell Bench Press', 'Barbell Bench Press - Medium Grip']::text[],
    array['Bench Press - Powerlifting', 'Wide-Grip Decline Barbell Bench Press', 'Barbell Bench Press - Medium Grip']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the chest region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Bench Press - Powerlifting', 'Wide-Grip Barbell Bench Press', 'Barbell Bench Press - Medium Grip']::text[],
    array['Bench Press - Powerlifting', 'Wide-Grip Barbell Bench Press', 'Barbell Bench Press - Medium Grip']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Letting momentum do the work instead of controlling the full rep.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the shoulders region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Upright Barbell Row', 'Low Pulley Row To Neck', 'Dumbbell One-Arm Upright Row']::text[],
    array['Upright Barbell Row', 'Low Pulley Row To Neck', 'Dumbbell One-Arm Upright Row']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the chest region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Bench Press - Powerlifting', 'Board Press', 'One Arm Floor Press']::text[],
    array['Bench Press - Powerlifting', 'Board Press', 'One Arm Floor Press']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the shoulders region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Single-Arm Linear Jammer', 'Jerk Balance', 'Rack Delivery']::text[],
    array['Jerk Balance', 'Rack Delivery', 'Single-Arm Linear Jammer']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Letting momentum do the work instead of controlling the full rep.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the shoulders region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Clean and Press', 'Standing Barbell Press Behind Neck', 'Anti-Gravity Press']::text[],
    array['Clean and Press', 'Standing Barbell Press Behind Neck', 'Anti-Gravity Press']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Letting momentum do the work instead of controlling the full rep.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the shoulders region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Bradford/Rocky Presses', 'Standing Bradford Press', 'Standing Military Press']::text[],
    array['Bradford/Rocky Presses', 'Standing Bradford Press', 'Standing Military Press']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the shoulders region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Dumbbell Raise', 'Smith Incline Shoulder Raise', 'Straight Raises on Incline Bench']::text[],
    array[]::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the legs region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Rocking Standing Calf Raise', 'Standing Barbell Calf Raise', 'Dumbbell Seated One-Leg Calf Raise']::text[],
    array['Rocking Standing Calf Raise', 'Standing Barbell Calf Raise']::text[],
  ...
  (
    ...
    array['Builds strength and control through the back region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Barbell Shrug', 'Barbell Shrug Behind The Back', 'Dumbbell Shrug']::text[],
    array['Barbell Shrug', 'Barbell Shrug Behind The Back']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the legs region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Barbell Seated Calf Raise', 'Standing Barbell Calf Raise', 'Dumbbell Seated One-Leg Calf Raise']::text[],
    array['Barbell Seated Calf Raise', 'Standing Barbell Calf Raise']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the shoulders region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Landmine Linear Jammer', 'Jerk Balance', 'Rack Delivery']::text[],
    array['Jerk Balance', 'Landmine Linear Jammer', 'Rack Delivery']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the legs region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Barbell Seated Calf Raise', 'Rocking Standing Calf Raise', 'Dumbbell Seated One-Leg Calf Raise']::text[],
    array['Barbell Seated Calf Raise', 'Rocking Standing Calf Raise']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Letting momentum do the work instead of controlling the full rep.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the shoulders region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Barbell Rear Delt Row', 'Low Pulley Row To Neck', 'Dumbbell One-Arm Upright Row']::text[],
    array['Barbell Rear Delt Row', 'Low Pulley Row To Neck', 'Dumbbell One-Arm Upright Row']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the chest region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Around The Worlds', 'Straight-Arm Dumbbell Pullover', 'Incline Dumbbell Bench With Palms Facing In']::text[],
    array['Around The Worlds', 'Straight-Arm Dumbbell Pullover', 'Incline Dumbbell Bench With Palms Facing In']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the chest region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Dumbbell Bench Press', 'Dumbbell Bench Press with Neutral Grip', 'Hammer Grip Incline DB Bench Press']::text[],
    array['Dumbbell Bench Press', 'Dumbbell Bench Press with Neutral Grip', 'Hammer Grip Incline DB Bench Press']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the chest region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Decline Dumbbell Bench Press', 'Dumbbell Bench Press', 'Dumbbell Bench Press with Neutral Grip']::text[],
    array['Decline Dumbbell Bench Press', 'Dumbbell Bench Press', 'Dumbbell Bench Press with Neutral Grip']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Letting momentum do the work instead of controlling the full rep.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the chest region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Hammer Grip Incline DB Bench Press', 'Barbell Incline Bench Press - Medium Grip', 'Incline Cable Chest Press']::text[],
    array['Hammer Grip Incline DB Bench Press']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the arms region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Close-Grip Barbell Bench Press', 'Bench Dips', 'Dips - Triceps Version']::text[],
    array['Close-Grip Barbell Bench Press']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the core region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Barbell Ab Rollout', 'Barbell Ab Rollout - On Knees', 'Barbell Rollout from Bench']::text[],
    array['Barbell Ab Rollout', 'Barbell Ab Rollout - On Knees', 'Barbell Rollout from Bench']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Skipping the setup and losing tension before the first rep starts.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the back region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Deficit Deadlift', 'Seated Good Mornings', 'Barbell Deadlift']::text[],
    array['Barbell Deadlift', 'Deficit Deadlift', 'Seated Good Mornings']::text[],
  ...
  (
    ...
    array['Builds strength and control through the legs region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Good Morning', 'Good Morning off Pins', 'Hanging Bar Good Morning']::text[],
    array['One-Arm Side Deadlift', 'Clean Deadlift', 'Good Morning']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Skipping the setup and losing tension before the first rep starts.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the legs region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Box Squat', 'Barbell Full Squat', 'Barbell Hack Squat']::text[],
    array['Barbell Full Squat', 'Barbell Hack Squat', 'Box Squat']::text[],
...
Caution: Always ensure that the dumbbell used for this exercise is secure. Using a dumbbell with loose plates can result in the dumbbell falling apart and falling on your face.', 'While keeping your arms straight, lower the weight slowly in an arc behind your head while breathing in until you feel a stretch on the chest.', 'At that point, bring the dumbbell back to the starting position using the arc through which the weight was lowered and exhale as you perform this movement.', 'Hold the weight on the initial position for a second and repeat the motion for the prescribed number of repetitions.']::text[],
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the chest region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Around The Worlds', 'Bent-Arm Dumbbell Pullover', 'Incline Dumbbell Bench With Palms Facing In']::text[],
    array['Around The Worlds', 'Bent-Arm Dumbbell Pullover', 'Incline Dumbbell Bench With Palms Facing In']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the core region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Barbell Rollout from Bench', 'Barbell Ab Rollout - On Knees', 'Landmine 180''s']::text[],
    array['Barbell Rollout from Bench', 'Barbell Ab Rollout - On Knees', 'Landmine 180''s']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the core region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Barbell Ab Rollout', 'Barbell Rollout from Bench', 'Landmine 180''s']::text[],
    array['Barbell Ab Rollout', 'Barbell Rollout from Bench', 'Landmine 180''s']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the back region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Barbell Shrug', 'Incline Bench Pull', 'Dumbbell Shrug']::text[],
    array['Barbell Shrug', 'Incline Bench Pull']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Skipping the setup and losing tension before the first rep starts.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the legs region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Speed Box Squat', 'Barbell Full Squat', 'Barbell Hack Squat']::text[],
    array['Barbell Full Squat', 'Barbell Hack Squat', 'Frankenstein Squat']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Skipping the setup and losing tension before the first rep starts.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the legs region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Barbell Squat To A Bench', 'Box Squat', 'Front Barbell Squat']::text[],
    array['Barbell Squat To A Bench', 'Front Barbell Squat', 'Front Barbell Squat To A Bench']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the legs region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Dumbbell Step Ups', 'Barbell Step Ups', 'Power Clean']::text[],
    array['Dumbbell Step Ups']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Skipping the setup and losing tension before the first rep starts.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the legs region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Dumbbell Squat', 'Plie Dumbbell Squat', 'Split Squat with Dumbbells']::text[],
    array['Dumbbell Squat', 'Plie Dumbbell Squat', 'Split Squat with Dumbbells']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Skipping the setup and losing tension before the first rep starts.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the legs region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Good Morning', 'Good Morning off Pins', 'Sumo Deadlift']::text[],
    array['Good Morning', 'Good Morning off Pins', 'Romanian Deadlift']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Skipping the setup and losing tension before the first rep starts.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the legs region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Dumbbell Squat', 'Split Squat with Dumbbells', 'Dumbbell Squat To A Bench']::text[],
    array['Dumbbell Squat', 'Split Squat with Dumbbells', 'Dumbbell Squat To A Bench']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Skipping the setup and losing tension before the first rep starts.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the legs region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Box Squat', 'Speed Box Squat', 'Barbell Full Squat']::text[],
    array['Barbell Full Squat', 'Barbell Hack Squat', 'Box Squat']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Skipping the setup and losing tension before the first rep starts.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the back region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Deficit Deadlift', 'Barbell Deadlift', 'Stiff Leg Barbell Good Morning']::text[],
    array['Barbell Deadlift', 'Deficit Deadlift', 'Stiff Leg Barbell Good Morning']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the shoulders region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Straight Raises on Incline Bench', 'Standing Front Barbell Raise Over Head', 'Alternating Deltoid Raise']::text[],
    array['Straight Raises on Incline Bench', 'Standing Front Barbell Raise Over Head']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Skipping the setup and losing tension before the first rep starts.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the legs region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Cable Deadlifts', 'Clean Deadlift', 'One-Arm Side Deadlift']::text[],
    array[]::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the core region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Barbell Ab Rollout', 'Barbell Ab Rollout - On Knees', 'Landmine 180''s']::text[],
    array['Barbell Ab Rollout', 'Barbell Ab Rollout - On Knees', 'Landmine 180''s']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Letting momentum do the work instead of controlling the full rep.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the back region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Bent Over Two-Dumbbell Row', 'Dumbbell Incline Row', 'One-Arm Dumbbell Row']::text[],
    array['Bent Over Two-Dumbbell Row', 'Dumbbell Incline Row', 'One-Arm Dumbbell Row']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Skipping the setup and losing tension before the first rep starts.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the back region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Seated Good Mornings', 'Barbell Deadlift', 'Stiff Leg Barbell Good Morning']::text[],
    array['Barbell Deadlift', 'Seated Good Mornings', 'Stiff Leg Barbell Good Morning']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the chest region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Decline Dumbbell Bench Press', 'Dumbbell Bench Press', 'Hammer Grip Incline DB Bench Press']::text[],
    array['Decline Dumbbell Bench Press', 'Dumbbell Bench Press', 'Hammer Grip Incline DB Bench Press']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Letting momentum do the work instead of controlling the full rep.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the back region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Bent Over Two-Dumbbell Row', 'Bent Over Two-Dumbbell Row With Palms In', 'One-Arm Dumbbell Row']::text[],
    array['Bent Over Two-Dumbbell Row', 'Bent Over Two-Dumbbell Row With Palms In', 'One-Arm Dumbbell Row']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the shoulders region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Arnold Dumbbell Press', 'Dumbbell Shoulder Press', 'Barbell Shoulder Press']::text[],
    array['Arnold Dumbbell Press', 'Dumbbell Shoulder Press']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the legs region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Dumbbell Lunges', 'Barbell Lunge', 'Elevated Back Lunge']::text[],
    array['Dumbbell Lunges']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Skipping the setup and losing tension before the first rep starts.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the legs region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Good Morning off Pins', 'Hanging Bar Good Morning', 'Sumo Deadlift']::text[],
    array['Good Morning off Pins', 'Hanging Bar Good Morning', 'Romanian Deadlift']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the back region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Rack Pulls', 'Bent-Arm Barbell Pullover', 'Snatch Shrug']::text[],
    array['Bent-Arm Barbell Pullover', 'Rack Pulls', 'Snatch Shrug']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the back region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Bent-Arm Barbell Pullover', 'Snatch Shrug', 'Clean Shrug']::text[],
    array['Bent-Arm Barbell Pullover', 'Snatch Shrug', 'Clean Shrug']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Letting momentum do the work instead of controlling the full rep.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the shoulders region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Standing Alternating Dumbbell Press', 'Standing Dumbbell Press', 'Standing Palm-In One-Arm Dumbbell Press']::text[],
    array['Standing Alternating Dumbbell Press', 'Standing Dumbbell Press', 'Standing Palm-In One-Arm Dumbbell Press']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Skipping the setup and losing tension before the first rep starts.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the legs region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Dumbbell Squat', 'Plie Dumbbell Squat', 'Dumbbell Squat To A Bench']::text[],
    array['Dumbbell Squat', 'Plie Dumbbell Squat', 'Dumbbell Squat To A Bench']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the shoulders region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Smith Incline Shoulder Raise', 'Straight Raises on Incline Bench', 'Dumbbell Lying One-Arm Rear Lateral Raise']::text[],
    array['Smith Incline Shoulder Raise', 'Straight Raises on Incline Bench']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Letting momentum do the work instead of controlling the full rep.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the shoulders region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Seated Dumbbell Press', 'Standing Alternating Dumbbell Press', 'Standing Dumbbell Press']::text[],
    array['Seated Dumbbell Press', 'Standing Alternating Dumbbell Press', 'Standing Dumbbell Press']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the chest region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Bent-Arm Dumbbell Pullover', 'Straight-Arm Dumbbell Pullover', 'Incline Dumbbell Bench With Palms Facing In']::text[],
    array['Bent-Arm Dumbbell Pullover', 'Straight-Arm Dumbbell Pullover', 'Incline Dumbbell Bench With Palms Facing In']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the shoulders region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Dumbbell Scaption', 'External Rotation', 'One-Arm Side Laterals']::text[],
    array[]::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Letting momentum do the work instead of controlling the full rep.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the shoulders region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['See-Saw Press (Alternating Side Press)', 'Standing Palms-In Dumbbell Press', 'Seated Dumbbell Press']::text[],
    array['See-Saw Press (Alternating Side Press)', 'Standing Palms-In Dumbbell Press', 'Seated Dumbbell Press']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the arms region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Incline Barbell Triceps Extension', 'Reverse Triceps Bench Press', 'Decline EZ Bar Triceps Extension']::text[],
    array['Incline Barbell Triceps Extension', 'Reverse Triceps Bench Press', 'Decline EZ Bar Triceps Extension']::text[],
  ...
  (
    ...
    'strength',
    true,
    array['Lay on the floor holding dumbbells in your hands. Your knees can be bent. Begin with the weights fully extended above you.', 'Lower the weights until your upper arm comes in contact with the floor. You can tuck your elbows to emphasize triceps size and strength, or to focus on your chest angle your arms to the side.', 'Pause at the bottom, and then bring the weight together at the top by extending through the elbows.']::text[],
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the chest region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Close-Grip Dumbbell Press', 'Decline Dumbbell Bench Press', 'Dumbbell Bench Press']::text[],
    array['Close-Grip Dumbbell Press', 'Decline Dumbbell Bench Press', 'Dumbbell Bench Press']::text[],
    'Dumbbell Floor Press Exercise: Muscles Worked, Tips, and How To Do It',
    'Learn how to do the Dumbbell Floor Press exercise, which muscles it works, the equipment you need, and common mistakes to avoid.',
    'free-exercise-db',
    'Unlicense'
  ),
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Letting momentum do the work instead of controlling the full rep.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the shoulders region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Barbell Rear Delt Row', 'Low Pulley Row To Neck', 'Upright Barbell Row']::text[],
    array['Barbell Rear Delt Row', 'Low Pulley Row To Neck', 'Upright Barbell Row']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Skipping the setup and losing tension before the first rep starts.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the legs region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Good Morning', 'Hanging Bar Good Morning', 'Sumo Deadlift']::text[],
    array['Good Morning', 'Hanging Bar Good Morning', 'Romanian Deadlift']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the arms region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Decline EZ Bar Triceps Extension', 'Standing Overhead Barbell Triceps Extension', 'Dumbbell One-Arm Triceps Extension']::text[],
    array['Decline EZ Bar Triceps Extension', 'Standing Overhead Barbell Triceps Extension', 'Dumbbell One-Arm Triceps Extension']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Skipping the setup and losing tension before the first rep starts.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the legs region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Barbell Squat To A Bench', 'Frankenstein Squat', 'Front Barbell Squat']::text[],
    array['Barbell Squat To A Bench', 'Front Barbell Squat', 'Front Barbell Squat To A Bench']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the arms region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Finger Curls', 'Seated Palm-Up Barbell Wrist Curl', 'EZ-Bar Curl']::text[],
    array['Finger Curls', 'Seated Palm-Up Barbell Wrist Curl', 'Barbell Curl']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the core region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Cable Crunch', 'Plank', 'Ab Crunch Machine']::text[],
    array[]::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Letting momentum do the work instead of controlling the full rep.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the shoulders region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Cuban Press', 'Standing Palms-In Dumbbell Press', 'Seated Dumbbell Press']::text[],
    array['Cuban Press', 'Standing Palms-In Dumbbell Press', 'Seated Dumbbell Press']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the legs region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Hang Snatch', 'Hang Snatch - Below Knees', 'Power Jerk']::text[],
    array['Hang Snatch', 'Hang Snatch - Below Knees', 'Power Jerk']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the shoulders region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Smith Incline Shoulder Raise', 'Standing Front Barbell Raise Over Head', 'Alternating Deltoid Raise']::text[],
    array['Smith Incline Shoulder Raise', 'Standing Front Barbell Raise Over Head']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the legs region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Clean from Blocks', 'Clean Pull', 'Hang Clean']::text[],
    array['Barbell Step Ups', 'Clean from Blocks', 'Clean Pull']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the arms region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Barbell Curl', 'Barbell Curls Lying Against An Incline', 'Close-Grip EZ Bar Curl']::text[],
    array['Barbell Curl', 'Barbell Curls Lying Against An Incline', 'Close-Grip EZ Bar Curl']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the arms region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Standing Overhead Barbell Triceps Extension', 'Incline Barbell Triceps Extension', 'Cable Rope Overhead Triceps Extension']::text[],
    array['Standing Overhead Barbell Triceps Extension', 'Incline Barbell Triceps Extension', 'Cable Rope Overhead Triceps Extension']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the shoulders region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Barbell Incline Shoulder Raise', 'Alternating Deltoid Raise', 'Bent Over Dumbbell Rear Delt Raise With Head On Bench']::text[],
    array[]::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the legs region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Calf Raise On A Dumbbell', 'Standing Dumbbell Calf Raise', 'Barbell Seated Calf Raise']::text[],
    array['Calf Raise On A Dumbbell', 'Standing Dumbbell Calf Raise']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the chest region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Decline Dumbbell Flyes', 'Dumbbell Flyes', 'Incline Dumbbell Flyes - With A Twist']::text[],
    array['Decline Dumbbell Flyes', 'Dumbbell Flyes', 'Incline Dumbbell Flyes - With A Twist']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the chest region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Decline Dumbbell Flyes', 'Dumbbell Flyes', 'Incline Dumbbell Flyes']::text[],
    array['Decline Dumbbell Flyes', 'Dumbbell Flyes', 'Incline Dumbbell Flyes']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the arms region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Incline Barbell Triceps Extension', 'Decline EZ Bar Triceps Extension', 'Standing Overhead Barbell Triceps Extension']::text[],
    array['Incline Barbell Triceps Extension', 'Decline EZ Bar Triceps Extension', 'Standing Overhead Barbell Triceps Extension']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the legs region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Hang Snatch', 'Hang Snatch - Below Knees', 'Power Snatch']::text[],
    array['Hang Snatch', 'Hang Snatch - Below Knees', 'Power Snatch']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the arms region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Decline Close-Grip Bench To Skull Crusher', 'Incline Barbell Triceps Extension', 'Decline EZ Bar Triceps Extension']::text[],
    array['Decline Close-Grip Bench To Skull Crusher', 'Incline Barbell Triceps Extension', 'Decline EZ Bar Triceps Extension']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the arms region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Drag Curl', 'Lying High Bench Barbell Curl', 'Barbell Curl']::text[],
    array['Drag Curl', 'Lying High Bench Barbell Curl', 'Barbell Curl']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the arms region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Finger Curls', 'EZ-Bar Curl', 'Flexor Incline Dumbbell Curls']::text[],
    array['Finger Curls', 'Barbell Curl', 'Barbell Curls Lying Against An Incline']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Letting momentum do the work instead of controlling the full rep.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the shoulders region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Seated Dumbbell Press', 'Standing Dumbbell Press', 'Standing Palm-In One-Arm Dumbbell Press']::text[],
    array['Seated Dumbbell Press', 'Standing Dumbbell Press', 'Standing Palm-In One-Arm Dumbbell Press']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the arms region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Decline EZ Bar Triceps Extension', 'Incline Barbell Triceps Extension', 'Cable Rope Overhead Triceps Extension']::text[],
    array['Decline EZ Bar Triceps Extension', 'Incline Barbell Triceps Extension', 'Cable Rope Overhead Triceps Extension']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Letting momentum do the work instead of controlling the full rep.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the shoulders region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Cuban Press', 'See-Saw Press (Alternating Side Press)', 'Seated Dumbbell Press']::text[],
    array['Cuban Press', 'See-Saw Press (Alternating Side Press)', 'Seated Dumbbell Press']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the arms region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Barbell Curl', 'Close-Grip EZ Bar Curl', 'Close-Grip Standing Barbell Curl']::text[],
    array['Barbell Curl', 'Close-Grip EZ Bar Curl', 'Close-Grip Standing Barbell Curl']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the legs region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Standing Dumbbell Calf Raise', 'Dumbbell Seated One-Leg Calf Raise', 'Barbell Seated Calf Raise']::text[],
    array['Standing Dumbbell Calf Raise', 'Dumbbell Seated One-Leg Calf Raise']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the shoulders region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Jerk Balance', 'Rack Delivery', 'Landmine Linear Jammer']::text[],
    array['Jerk Balance', 'Landmine Linear Jammer', 'Rack Delivery']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the legs region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Clean', 'Clean Pull', 'Hang Clean']::text[],
    array['Barbell Step Ups', 'Clean', 'Clean Pull']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Letting momentum do the work instead of controlling the full rep.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the back region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['One Arm Lat Pulldown', 'Wide-Grip Lat Pulldown', 'Full Range-Of-Motion Lat Pulldown']::text[],
    array['One Arm Lat Pulldown', 'Wide-Grip Lat Pulldown', 'Full Range-Of-Motion Lat Pulldown']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the chest region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Dumbbell Flyes', 'Incline Dumbbell Flyes', 'Incline Dumbbell Flyes - With A Twist']::text[],
    array['Dumbbell Flyes', 'Incline Dumbbell Flyes', 'Incline Dumbbell Flyes - With A Twist']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the arms region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Lying High Bench Barbell Curl', 'Seated Close-Grip Concentration Barbell Curl', 'Barbell Curl']::text[],
    array['Lying High Bench Barbell Curl', 'Seated Close-Grip Concentration Barbell Curl', 'Barbell Curl']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the chest region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Decline Dumbbell Flyes', 'Incline Dumbbell Flyes', 'Incline Dumbbell Flyes - With A Twist']::text[],
    array['Decline Dumbbell Flyes', 'Incline Dumbbell Flyes', 'Incline Dumbbell Flyes - With A Twist']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Letting momentum do the work instead of controlling the full rep.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the back region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Full Range-Of-Motion Lat Pulldown', 'Seated One-arm Cable Pulley Rows', 'Upright Cable Row']::text[],
    array['Full Range-Of-Motion Lat Pulldown', 'Seated One-arm Cable Pulley Rows', 'Upright Cable Row']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the arms region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Seated Palm-Up Barbell Wrist Curl', 'EZ-Bar Curl', 'Flexor Incline Dumbbell Curls']::text[],
    array['Seated Palm-Up Barbell Wrist Curl', 'Barbell Curl', 'Barbell Curls Lying Against An Incline']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Skipping the setup and losing tension before the first rep starts.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the legs region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Jerk Dip Squat', 'Olympic Squat', 'Barbell Full Squat']::text[],
    array['Barbell Full Squat', 'Barbell Hack Squat', 'Box Squat']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the legs region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Hang Snatch - Below Knees', 'Power Jerk', 'Power Snatch']::text[],
    array['Hang Snatch - Below Knees', 'Power Jerk', 'Power Snatch']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the legs region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Hang Snatch', 'Power Jerk', 'Power Snatch']::text[],
    array['Hang Snatch', 'Power Jerk', 'Power Snatch']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the arms region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Drag Curl', 'Seated Close-Grip Concentration Barbell Curl', 'Barbell Curl']::text[],
    array['Drag Curl', 'Seated Close-Grip Concentration Barbell Curl', 'Barbell Curl']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Letting momentum do the work instead of controlling the full rep.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the back region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Elevated Cable Rows', 'Full Range-Of-Motion Lat Pulldown', 'Upright Cable Row']::text[],
    array['Elevated Cable Rows', 'Full Range-Of-Motion Lat Pulldown', 'Upright Cable Row']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Letting momentum do the work instead of controlling the full rep.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the shoulders region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Seated Dumbbell Press', 'Standing Alternating Dumbbell Press', 'Standing Palm-In One-Arm Dumbbell Press']::text[],
    array['Seated Dumbbell Press', 'Standing Alternating Dumbbell Press', 'Standing Palm-In One-Arm Dumbbell Press']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Letting momentum do the work instead of controlling the full rep.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the back region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Full Range-Of-Motion Lat Pulldown', 'Close-Grip Front Lat Pulldown', 'One Arm Lat Pulldown']::text[],
    array['Full Range-Of-Motion Lat Pulldown', 'Close-Grip Front Lat Pulldown', 'One Arm Lat Pulldown']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Letting momentum do the work instead of controlling the full rep.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the back region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Full Range-Of-Motion Lat Pulldown', 'V-Bar Pulldown', 'Close-Grip Front Lat Pulldown']::text[],
    array['Full Range-Of-Motion Lat Pulldown', 'V-Bar Pulldown', 'Close-Grip Front Lat Pulldown']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Skipping the setup and losing tension before the first rep starts.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the legs region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Romanian Deadlift from Deficit', 'Snatch Deadlift', 'Good Morning']::text[],
    array['Good Morning', 'Good Morning off Pins', 'Hanging Bar Good Morning']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the legs region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Clean', 'Clean from Blocks', 'Hang Clean']::text[],
    array['Barbell Step Ups', 'Clean', 'Clean from Blocks']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the back region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Middle Back Shrug', 'Barbell Shrug', 'Barbell Shrug Behind The Back']::text[],
    array['Middle Back Shrug']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the shoulders region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Dumbbell Scaption', 'One-Arm Side Laterals', 'Power Partials']::text[],
    array['Dumbbell Scaption', 'One-Arm Side Laterals', 'Power Partials']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the back region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Dumbbell Shrug', 'Barbell Shrug', 'Barbell Shrug Behind The Back']::text[],
    array['Dumbbell Shrug']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Skipping the setup and losing tension before the first rep starts.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the legs region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Frankenstein Squat', 'Jerk Dip Squat', 'Barbell Full Squat']::text[],
    array['Barbell Full Squat', 'Barbell Hack Squat', 'Box Squat']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the shoulders region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Dumbbell Scaption', 'External Rotation', 'Power Partials']::text[],
    array['Dumbbell Scaption', 'External Rotation', 'Power Partials']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the shoulders region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Reverse Flyes With External Rotation', 'Dumbbell Scaption', 'External Rotation']::text[],
    array['Reverse Flyes With External Rotation', 'Dumbbell Scaption', 'External Rotation']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the shoulders region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Reverse Flyes', 'Dumbbell Scaption', 'External Rotation']::text[],
    array['Reverse Flyes', 'Dumbbell Scaption', 'External Rotation']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Skipping the setup and losing tension before the first rep starts.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the legs region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Snatch Deadlift', 'Clean Deadlift', 'Good Morning']::text[],
    array['Good Morning', 'Good Morning off Pins', 'Hanging Bar Good Morning']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the shoulders region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Dumbbell Lying One-Arm Rear Lateral Raise', 'Dumbbell Lying Rear Lateral Raise', 'Lying One-Arm Lateral Raise']::text[],
    array['Dumbbell Lying One-Arm Rear Lateral Raise', 'Dumbbell Lying Rear Lateral Raise', 'Lying One-Arm Lateral Raise']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Skipping the setup and losing tension before the first rep starts.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the legs region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Romanian Deadlift from Deficit', 'Clean Deadlift', 'Good Morning']::text[],
    array['Good Morning', 'Good Morning off Pins', 'Hanging Bar Good Morning']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the core region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Landmine 180''s', 'Ab Roller', 'Barbell Ab Rollout']::text[],
    array[]::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the legs region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Calf Raise On A Dumbbell', 'Dumbbell Seated One-Leg Calf Raise', 'Barbell Seated Calf Raise']::text[],
    array['Calf Raise On A Dumbbell', 'Dumbbell Seated One-Leg Calf Raise']::text[],
  ...
  (
    ...
    array['Builds strength and control through the arms region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Finger Curls', 'Seated Palm-Up Barbell Wrist Curl', 'EZ-Bar Curl']::text[],
    array['Finger Curls', 'Seated Palm-Up Barbell Wrist Curl']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the shoulders region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Bent Over Dumbbell Rear Delt Raise With Head On Bench', 'Dumbbell Incline Shoulder Raise', 'Front Dumbbell Raise']::text[],
    array['Bent Over Dumbbell Rear Delt Raise With Head On Bench', 'Dumbbell Incline Shoulder Raise', 'Front Dumbbell Raise']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the glutes region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Barbell Hip Thrust', 'Pull Through']::text[],
    array['Barbell Hip Thrust']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Skipping the setup and losing tension before the first rep starts.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the legs region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Stiff-Legged Dumbbell Deadlift', 'Clean Deadlift', 'One-Arm Side Deadlift']::text[],
    array[]::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Letting momentum do the work instead of controlling the full rep.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the shoulders region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Low Pulley Row To Neck', 'Barbell Rear Delt Row', 'Upright Barbell Row']::text[],
    array['Low Pulley Row To Neck']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the back region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Snatch Shrug', 'Bent-Arm Barbell Pullover', 'Rack Pulls']::text[],
    array['Bent-Arm Barbell Pullover', 'Rack Pulls', 'Snatch Shrug']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the shoulders region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Alternating Deltoid Raise', 'Bent Over Dumbbell Rear Delt Raise With Head On Bench', 'Front Dumbbell Raise']::text[],
    array['Alternating Deltoid Raise', 'Bent Over Dumbbell Rear Delt Raise With Head On Bench', 'Front Dumbbell Raise']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the shoulders region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Dumbbell Lying Rear Lateral Raise', 'Lying One-Arm Lateral Raise', 'Lying Rear Delt Raise']::text[],
    array['Dumbbell Lying Rear Lateral Raise', 'Lying One-Arm Lateral Raise', 'Lying Rear Delt Raise']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the shoulders region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Dumbbell Lying One-Arm Rear Lateral Raise', 'Lying One-Arm Lateral Raise', 'Lying Rear Delt Raise']::text[],
    array['Dumbbell Lying One-Arm Rear Lateral Raise', 'Lying One-Arm Lateral Raise', 'Lying Rear Delt Raise']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Skipping the setup and losing tension before the first rep starts.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the legs region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Frankenstein Squat', 'Olympic Squat', 'Barbell Full Squat']::text[],
    array['Barbell Full Squat', 'Barbell Hack Squat', 'Box Squat']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Letting momentum do the work instead of controlling the full rep.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the back region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Kneeling High Pulley Row', 'Shotgun Row', 'Upright Cable Row']::text[],
    array['Kneeling High Pulley Row', 'Shotgun Row', 'Upright Cable Row']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the shoulders region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Dumbbell Lying One-Arm Rear Lateral Raise', 'Dumbbell Lying Rear Lateral Raise', 'Lying Rear Delt Raise']::text[],
    array['Dumbbell Lying One-Arm Rear Lateral Raise', 'Dumbbell Lying Rear Lateral Raise', 'Lying Rear Delt Raise']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Letting momentum do the work instead of controlling the full rep.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the back region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Close-Grip Front Lat Pulldown', 'Wide-Grip Lat Pulldown', 'Full Range-Of-Motion Lat Pulldown']::text[],
    array['Close-Grip Front Lat Pulldown', 'Wide-Grip Lat Pulldown', 'Full Range-Of-Motion Lat Pulldown']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Letting momentum do the work instead of controlling the full rep.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the back region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Kneeling High Pulley Row', 'Kneeling Single-Arm High Pulley Row', 'Upright Cable Row']::text[],
    array['Kneeling High Pulley Row', 'Kneeling Single-Arm High Pulley Row', 'Upright Cable Row']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the back region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Bent-Arm Barbell Pullover', 'Clean Shrug', 'Rack Pulls']::text[],
    array['Bent-Arm Barbell Pullover', 'Rack Pulls', 'Clean Shrug']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the chest region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Cable Chest Press', 'Incline Cable Chest Press', 'Barbell Bench Press - Medium Grip']::text[],
    array['Cable Chest Press', 'Incline Cable Chest Press']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Letting momentum do the work instead of controlling the full rep.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the back region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Kneeling High Pulley Row', 'Kneeling Single-Arm High Pulley Row', 'Shotgun Row']::text[],
    array['Kneeling High Pulley Row', 'Kneeling Single-Arm High Pulley Row', 'Shotgun Row']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the shoulders region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Iron Cross', 'Landmine Linear Jammer', 'Single-Arm Linear Jammer']::text[],
    array[]::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the arms region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Dumbbell Lying Supination', 'Dumbbell Prone Incline Curl', 'Standing Inner-Biceps Curl']::text[],
    array['Dumbbell Lying Supination', 'Dumbbell Prone Incline Curl', 'Standing Inner-Biceps Curl']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the arms region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Dumbbell Lying Pronation', 'Dumbbell Prone Incline Curl', 'Standing Inner-Biceps Curl']::text[],
    array['Dumbbell Lying Pronation', 'Dumbbell Prone Incline Curl', 'Standing Inner-Biceps Curl']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the arms region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Standing Inner-Biceps Curl', 'Flexor Incline Dumbbell Curls', 'Seated Dumbbell Inner Biceps Curl']::text[],
    array['Standing Inner-Biceps Curl', 'Flexor Incline Dumbbell Curls', 'Seated Dumbbell Inner Biceps Curl']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the arms region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Seated Dumbbell Inner Biceps Curl', 'Standing One-Arm Dumbbell Curl Over Incline Bench', 'Dumbbell Prone Incline Curl']::text[],
    array['Seated Dumbbell Inner Biceps Curl', 'Standing One-Arm Dumbbell Curl Over Incline Bench', 'Dumbbell Prone Incline Curl']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the chest region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Cable Chest Press', 'Standing Cable Chest Press', 'Barbell Incline Bench Press - Medium Grip']::text[],
    array['Cable Chest Press', 'Standing Cable Chest Press', 'Barbell Incline Bench Press - Medium Grip']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the shoulders region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Landmine Linear Jammer', 'Single-Arm Linear Jammer', 'Cable Internal Rotation']::text[],
    array[]::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the shoulders region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Rack Delivery', 'Clean and Jerk', 'Landmine Linear Jammer']::text[],
    array['Landmine Linear Jammer', 'Rack Delivery', 'Single-Arm Linear Jammer']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Letting momentum do the work instead of controlling the full rep.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the back region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Kneeling Single-Arm High Pulley Row', 'Shotgun Row', 'Upright Cable Row']::text[],
    array['Kneeling Single-Arm High Pulley Row', 'Shotgun Row', 'Upright Cable Row']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Letting momentum do the work instead of controlling the full rep.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the shoulders region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Barbell Rear Delt Row', 'Upright Barbell Row', 'Cable Rope Rear-Delt Rows']::text[],
    array['Barbell Rear Delt Row', 'Upright Barbell Row', 'Cable Rope Rear-Delt Rows']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the arms region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Decline Dumbbell Triceps Extension', 'One Arm Supinated Dumbbell Triceps Extension', 'Seated Bent-Over One-Arm Dumbbell Triceps Extension']::text[],
    array['Decline Dumbbell Triceps Extension', 'One Arm Supinated Dumbbell Triceps Extension', 'Seated Bent-Over One-Arm Dumbbell Triceps Extension']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the arms region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Decline Dumbbell Triceps Extension', 'One Arm Pronated Dumbbell Triceps Extension', 'Seated Bent-Over One-Arm Dumbbell Triceps Extension']::text[],
    array['Decline Dumbbell Triceps Extension', 'One Arm Pronated Dumbbell Triceps Extension', 'Seated Bent-Over One-Arm Dumbbell Triceps Extension']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the arms region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Flexor Incline Dumbbell Curls', 'Seated Dumbbell Inner Biceps Curl', 'Standing One-Arm Dumbbell Curl Over Incline Bench']::text[],
    array['Flexor Incline Dumbbell Curls', 'Seated Dumbbell Inner Biceps Curl', 'Standing One-Arm Dumbbell Curl Over Incline Bench']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the shoulders region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Barbell Shoulder Press', 'Arnold Dumbbell Press', 'Dumbbell One-Arm Shoulder Press']::text[],
    array['Barbell Shoulder Press']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the shoulders region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Jerk Balance', 'Clean and Jerk', 'Landmine Linear Jammer']::text[],
    array['Jerk Balance', 'Landmine Linear Jammer', 'Single-Arm Linear Jammer']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the arms region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Decline Dumbbell Triceps Extension', 'One Arm Pronated Dumbbell Triceps Extension', 'One Arm Supinated Dumbbell Triceps Extension']::text[],
    array['Decline Dumbbell Triceps Extension', 'One Arm Pronated Dumbbell Triceps Extension', 'One Arm Supinated Dumbbell Triceps Extension']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the arms region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Dumbbell One-Arm Triceps Extension', 'Decline Dumbbell Triceps Extension', 'One Arm Pronated Dumbbell Triceps Extension']::text[],
    array['Dumbbell One-Arm Triceps Extension', 'Decline Dumbbell Triceps Extension', 'One Arm Pronated Dumbbell Triceps Extension']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the arms region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Flexor Incline Dumbbell Curls', 'Standing One-Arm Dumbbell Curl Over Incline Bench', 'Dumbbell Prone Incline Curl']::text[],
    array['Flexor Incline Dumbbell Curls', 'Standing One-Arm Dumbbell Curl Over Incline Bench', 'Dumbbell Prone Incline Curl']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the arms region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Dumbbell Prone Incline Curl', 'Standing Inner-Biceps Curl', 'Flexor Incline Dumbbell Curls']::text[],
    array['Dumbbell Prone Incline Curl', 'Standing Inner-Biceps Curl', 'Flexor Incline Dumbbell Curls']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the arms region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Dumbbell Prone Incline Curl', 'Flexor Incline Dumbbell Curls', 'Seated Dumbbell Inner Biceps Curl']::text[],
    array['Dumbbell Prone Incline Curl', 'Flexor Incline Dumbbell Curls', 'Seated Dumbbell Inner Biceps Curl']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the arms region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Flexor Incline Dumbbell Curls', 'Seated Dumbbell Inner Biceps Curl', 'Dumbbell Prone Incline Curl']::text[],
    array['Flexor Incline Dumbbell Curls', 'Seated Dumbbell Inner Biceps Curl', 'Dumbbell Prone Incline Curl']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the arms region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Zottman Preacher Curl', 'Alternate Hammer Curl', 'Alternate Incline Dumbbell Curl']::text[],
    array['Zottman Preacher Curl', 'Alternate Hammer Curl', 'Alternate Incline Dumbbell Curl']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the arms region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Zottman Curl', 'Alternate Hammer Curl', 'Alternate Incline Dumbbell Curl']::text[],
    array['Zottman Curl', 'Alternate Hammer Curl', 'Alternate Incline Dumbbell Curl']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the arms region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Alternate Hammer Curl', 'Concentration Curls', 'Dumbbell Alternate Bicep Curl']::text[],
    array['Alternate Hammer Curl', 'Concentration Curls', 'Dumbbell Alternate Bicep Curl']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the shoulders region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Cable Shoulder Press', 'Seated Cable Shoulder Press', 'Arnold Dumbbell Press']::text[],
    array['Cable Shoulder Press', 'Seated Cable Shoulder Press']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the legs region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Leg Extensions', 'Lying Leg Curls', 'Barbell Step Ups']::text[],
    array[]::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the core region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['3/4 Sit-Up', 'Cable Crunch', 'Plank']::text[],
    array[]::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the shoulders region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Alternating Cable Shoulder Press', 'Seated Cable Shoulder Press', 'Arnold Dumbbell Press']::text[],
    array['Alternating Cable Shoulder Press', 'Seated Cable Shoulder Press']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the arms region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['One Arm Pronated Dumbbell Triceps Extension', 'One Arm Supinated Dumbbell Triceps Extension', 'Seated Bent-Over One-Arm Dumbbell Triceps Extension']::text[],
    array['One Arm Pronated Dumbbell Triceps Extension', 'One Arm Supinated Dumbbell Triceps Extension', 'Seated Bent-Over One-Arm Dumbbell Triceps Extension']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the arms region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['Alternate Hammer Curl', 'Alternate Incline Dumbbell Curl', 'Concentration Curls']::text[],
    array['Alternate Hammer Curl', 'Alternate Incline Dumbbell Curl', 'Concentration Curls']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Cutting the range of motion short and rushing through the reps.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the shoulders region.', 'Makes it easier to focus on one area when you want extra practice or volume.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['External Rotation', 'One-Arm Side Laterals', 'Power Partials']::text[],
    array['External Rotation', 'One-Arm Side Laterals', 'Power Partials']::text[],
  ...
  (
    ...
    array['Using more weight or speed than you can control cleanly.', 'Letting momentum do the work instead of controlling the full rep.', 'Changing your body position between reps instead of keeping the movement repeatable.']::text[],
    array['Builds strength and control through the back region.', 'Trains multiple joints at once, which can make your sessions more efficient.', 'Gives you a repeatable way to track progress inside Logbook over time.']::text[],
    array['V-Bar Pulldown', 'Close-Grip Front Lat Pulldown', 'One Arm Lat Pulldown']::text[],
    array['V-Bar Pulldown', 'Close-Grip Front Lat Pulldown', 'One Arm Lat Pulldown']::text[],
