...
const en: StageAnalysisMessages = {
  seo: {
    posing_analysis: { title: "AI Bodybuilding Posing Analysis | StageLab", description: "Upload a short posing video and receive structured StageLab feedback on presentation, detected poses, strengths, and priority corrections." },
  ...
  landing: {
    posing_analysis: {
      eyebrow: "StageLab AI Posing Analysis",
...
const es: StageAnalysisMessages = {
  ...en,
  seo: {
    posing_analysis: { title: "Análisis de poses de fisicoculturismo con IA | StageLab", description: "Sube un video corto de poses y recibe comentarios estructurados de StageLab sobre presentación, poses detectadas y correcciones prioritarias." },
...
const pt: StageAnalysisMessages = {
  ...en,
  seo: {
    posing_analysis: { title: "Análise de poses de fisiculturismo com IA | StageLab", description: "Envie um vídeo curto de poses e receba feedback estruturado da StageLab sobre apresentação, poses detectadas e correções prioritárias." },
