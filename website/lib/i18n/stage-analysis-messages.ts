  ...
  landing: {
    posing_analysis: {
      ...
      faq: [
        ...
        { question: "Are videos saved?", answer: "Your original video stays on your device. ElevareFit does not receive or store it. Browser-extracted frames upload directly to StageLab private temporary storage and are deleted by StageLab's cleanup process." },
