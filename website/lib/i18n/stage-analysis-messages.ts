  ...
  landing: {
    posing_analysis: {
      ...
      faq: [
        ...
        { question: "Are videos saved?", answer: "Posing videos and frames are temporarily stored in StageLab private storage. Selected frames go to OpenAI. StageLab attempts deletion after processing or failure, and scheduled cleanup handles remaining and abandoned uploads while protecting active jobs. This is separate from saved results and provider retention; see the Privacy Policy." },
