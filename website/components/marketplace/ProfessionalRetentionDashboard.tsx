      ...
      {!isLoading && summary && profile ? (
        <>
          ...
          <div className="retention-metrics">
            <article className="panel"><span className="stat-label">{t("Legitimate profile views")}</span><strong>{number.format(rangeDays === 30 ? summary.views_in_range : summary.views_all_time)}</strong><p>{t("Counted once per consenting browser per day. Bots and your own signed-in views are excluded.")}</p></article>
