...
<div className="checkin-photo-grid">
  <section className="checkin-photo-card">
    <h3>Front</h3>
    <img
      src="/blog-posts/mens-physique-classic-physique-prep-12-weeks-out/front.webp"
  ...
  <section className="checkin-photo-card">
    <h3>Side</h3>
    <img
      src="/blog-posts/mens-physique-classic-physique-prep-12-weeks-out/side.webp"
  ...
  <section className="checkin-photo-card">
    <h3>Back</h3>
    <img
      src="/blog-posts/mens-physique-classic-physique-prep-12-weeks-out/back.webp"
